...
from APAexp import Process,JavaProcess,PythonProcess
...
timelimit = 1      # in seconds; if we exceed this, we don't try anything bigger
...
simpJava=JavaProcess("javaSol/Simple.java")
dictJava=JavaProcess("javaSol/HashPairs.java")

simpPyth=PythonProcess('pythonSol/simple.py')
dictPyth=PythonProcess('pythonSol/fastDict.py')
